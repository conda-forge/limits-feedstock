...
Once the `conda-forge` channel has been enabled, `limits` can be installed with:

```
conda install limits
```

It is possible to list all of the versions of `limits` available on your platform with:
